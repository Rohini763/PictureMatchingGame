...
public class Images3 extends AppCompatActivity {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (currentPos < 0 ) {
                    ...
                    if (currentPos == position) {
                        ...
                        Toast.makeText(com.example.myproject.Images3.this, "Not Match!", Toast.LENGTH_LONG).show();
                    } else {
                        ((ImageView) view).setImageResource(drawable[pos[position]]);
                        countPair++;
                        if (countPair == 12) {
                            Toast.makeText(com.example.myproject.Images3.this, "You Win!", Toast.LENGTH_LONG).show();
                        }
                    }
                    currentPos = -1;
                }
